...
const Login = (props) =>{
    ...
    const handleFormSubmit = async(formProps) => {
        ...
        setIsLoading(true);
        await auth()
            .signInWithEmailAndPassword(formProps.email, formProps.password)
            .then(async (e) => {
                setIsLoading(false);
                console.log(e);
                AsyncStorage.setItem('user',JSON.stringify(e));
            ...
            .catch(async error => {
                ...
                if (error.code === 'auth/internal-error') {
                    await alert({
                        ...
                        title: 'Success',
                        message: 'That email address is not register please!',
                      });                
                }
                      ...
                      render={({ handleSubmit, form, submitting, pristine, values }) => (
                        ...
                        <Field name="email">
                            ...
                            <View style={{flexDirection:'row',alignItems:'center',justifyContent:'flex-end'}}>
                                <TouchableOpacity style={{marginLeft:5}} onPress={()=>props.navigation.navigate('Register')}>
                                    <Text style={{ color: '#222', fontSize: 15, marginTop: 20}} >Don't have an account? Register</Text>
                                </TouchableOpacity>
                            </View>
